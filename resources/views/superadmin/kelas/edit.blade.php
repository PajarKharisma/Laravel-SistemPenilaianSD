...
<div class="box box-info">
    ...
    <form class="form-horizontal" method="post" action="{{url('kelas/update/'.$edit->id_kelas)}}">
        @csrf
        <div class="box-body">
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <input class="form-control" id="kode_kelas" name="kode_kelas" placeholder="Masukan Kode Kelas" value="{{ $edit->kode_kelas }}" required>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <input class="form-control" id="nama_kelas" name="nama_kelas" placeholder="Masukan Nama Kelas" value="{{ $edit->nama_kelas }}" required>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-4">
                    <input type="hidden" name="id_guru" id="id_guru" value="{{ $edit->id_guru }}">
                    <input class="form-control" id="nama_guru" name="nama_guru" placeholder="Masukan Nama Guru" value="{{ $edit->nama_guru }}" readonly required>
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-4">
                    <input type="hidden" name="id_ta" id="id_ta" value="{{ $edit->id_ta }}">
                    <input class="form-control" id="nama_ta" name="nama_ta" placeholder="Masukan Tahun Ajaran" value="{{ $edit->nama_ta }}" readonly required>
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-4">
                    <input type="hidden" name="id_semester" id="id_semester" value="{{ $edit->id_semester }}">
                    <input class="form-control" id="nama_semester" name="nama_semester" placeholder="Masukan Semester" value="{{ $edit->nama_semester }}" readonly required>
                </div>
