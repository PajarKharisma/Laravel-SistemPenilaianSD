...
<div class="box box-info">
    ...
    <form class="form-horizontal" method="post" action="{{ url('user/update/'.$edit->id) }}">
        @csrf
        <div class="box-body">
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <input class="form-control" id="username" name="username" placeholder="Masukan Username" value="{{ $edit->username }}" required autofocus>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <select id="jabatan" name="jabatan" class="form-control">
                        <option id="walikelas" value="998">Wali Kelas</option>
                        <option id="pimpinan" value="0">Kepala Sekolah</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-4">
                    ...
                    <input class="form-control" id="kode_kelas" name="kode_kelas" placeholder="Masukan Kode Kelas" value="{{ $edit->kode_kelas }}" readonly required>
                </div>
...
function setJabatan(){
    let jabatan = <?php echo $edit->jabatan; ?>;
    if(jabatan == 998){
        $('#walikelas').attr("selected","selected");
    } else {
        $('#pimpinan').attr("selected","selected");
    }
}
